...
public class Lang
{
	...
	public static void german() {
		...
		CHAT_IS_IN_SLOWMODE = "&cDie Gespräch ist PauseMode! Nur berechtigte Spieler dürfen sprechen";
		SERVER_IS_NOW_IN_SLOWMODE = "&a[SlowChat] Die Gespräch ist jetzt PauseMode, Nur berechtigte Spieler dürfen sprechen";
		SERVER_IS_NO_LONGER_IN_SLOWMODE = "&a[SlowChat] Die Gespräch ist nicht mehr in PauseMode!";
